// BepuPhysics is server-only. The Unity client never runs the Bepu physics
// world (client prediction uses the pure math in PlayerSimulation), so this
// whole file compiles out under Unity to avoid a BepuPhysics dependency.
