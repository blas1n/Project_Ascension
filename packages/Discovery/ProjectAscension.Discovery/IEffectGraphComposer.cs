...
/// skill's graph shape), the NAMES already in use (don't reproduce an existing skill's identity
/// either — a rename of a duplicate is still a duplicate), and the composed LINEAGE to build on
/// (evolve prior discoveries).</summary>
